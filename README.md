...
**[mikaaouo](https://www.twitch.tv/mikaaouo)** is an ever-evolving professional streamer on the popular Twitch platform.

One of the cornerstones of nurturing a successful online platform is by developing a strong, professional online presence. 

The goal of this project is to extend this capacity by building a personal website for our client, which in this current time aims to be a visually-striking, light-weight, social hub.

### 📊 Repository Contribution Activity
[TO BE ADDED IN PUBLIC RELEASE]
